...
function apiForNameGame() {
  ...
  return (
    <>
      ...
      <p>Félicitation {user}, notre equipe vous attend le {date} dans notre salle {gameName} pour l'experience la plus démentielle de votre vie ! ps : N'oubliez pas de laissez votre peur à la maison  </p>
      <Footer />
    </>
  );
}
